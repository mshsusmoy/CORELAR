...
namespace API.Data.Migrations
{
    ...
    [Migration("20220114054259_StatusEntityAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.Status", b =>
                {
                    ...
                    b.Property<int?>("StatusOwnerId")
                        .HasColumnType("integer");

                    b.Property<string>("StatusOwnerName")
                        .HasColumnType("text");

                    b.Property<DateTime>("StatusPostTime")
                        .HasColumnType("timestamp without time zone");

                    b.HasKey("Id");

                    b.HasIndex("StatusOwnerId");
            ...
            modelBuilder.Entity("API.Entities.Status", b =>
                {
                    b.HasOne("API.Entities.AppUser", "StatusOwner")
                        .WithMany("Statuses")
                        .HasForeignKey("StatusOwnerId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("StatusOwner");
                });
